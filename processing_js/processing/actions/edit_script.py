...
from processing_js.gui.script_editor.script_editor_dialog import ScriptEditorDialog
...
class EditScriptAction(ContextAction):
    ...
    def isEnabled(self):
        """
         ...
         """
        return isinstance(self.itemData, QgsProcessingAlgorithm) and self.itemData.provider().id() == "js" and self.itemData.is_user_script
