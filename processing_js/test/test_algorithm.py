...
class AlgorithmTest(unittest.TestCase):
    ...
    def testScriptParsing(self):  # pylint: disable=too-many-locals,too-many-statements
        ...
        """
        alg = JsAlgorithm(description_file=os.path.join(test_data_path, 'test_algorithm_1.rsx'))
        alg.initAlgorithm()
        ...
        alg = JsAlgorithm(description_file=os.path.join(test_data_path, 'test_algorithm_2.rsx'))
        alg.initAlgorithm()
        self.assertFalse(alg.error)
    ...
    def testBadAlgorithm(self):
        ...
        Test a bad script
        """
        alg = JsAlgorithm(description_file=os.path.join(test_data_path, 'bad_algorithm.rsx'))
        alg.initAlgorithm()
    ...
    def testReadOgr(self):
        ...
        """
        alg = JsAlgorithm(description_file=os.path.join(test_data_path, 'test_vectorin.rsx'))
        alg.initAlgorithm()
    ...
    def testRasterIn(self):
        ...
        """
        alg = JsAlgorithm(description_file=os.path.join(test_data_path, 'test_rasterin.rsx'))
        alg.initAlgorithm()
        ...
        alg = JsAlgorithm(description_file=os.path.join(test_data_path, 'test_rasterin_names.rsx'))
        alg.initAlgorithm()
        script = alg.build_import_commands({'Layer': os.path.join(test_data_path, 'dem.tif')}, context, feedback)
        ...
        alg = JsAlgorithm(description_file=os.path.join(test_data_path, 'test_rasterin_norasterpackage.rsx'))
        alg.initAlgorithm()
        script = alg.build_import_commands({'Layer': os.path.join(test_data_path, 'dem.tif')}, context, feedback)
    ...
    def testMultiRasterIn(self):
        ...
        """
        alg = JsAlgorithm(description_file=os.path.join(test_data_path, 'test_multirasterin.rsx'))
        alg.initAlgorithm()
    ...
    def testMultiVectorIn(self):
        ...
        """
        alg = JsAlgorithm(description_file=os.path.join(test_data_path, 'test_multivectorin.rsx'))
        alg.initAlgorithm()
    ...
    def testVectorOutputs(self):
        ...
        """
        alg = JsAlgorithm(description_file=os.path.join(test_data_path, 'test_vectorout.rsx'))
        alg.initAlgorithm()
